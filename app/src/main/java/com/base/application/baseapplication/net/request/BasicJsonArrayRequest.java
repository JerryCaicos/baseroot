...
/**
 * JSONArray请求,{@link JSONArray}
 *
 * @Title:
 * @Description:
 * @Version:
 */
public class BasicJsonArrayRequest extends JsonRequest<JSONArray>
{
	/**
	 * Log TAG.
	 */
	private static final String TAG = "BasicJsonArrayRequest";
	 ...
	 * Content-Type
	 **/
	private String bodyContentType = PROTOCOL_CONTENT_TYPE;
	 ...
	 * @param errorListener
	 */
	public BasicJsonArrayRequest(int method,String url,String requestBody,
	...
	/**
	 * 设置  Content-Type, 默认 {@link #PROTOCOL_CONTENT_TYPE}
	 *
	 * @param bodyContentType
	 */
	public final void setBodyContentType(String bodyContentType)
	{
