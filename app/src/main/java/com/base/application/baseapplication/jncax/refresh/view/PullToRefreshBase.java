...
import com.base.application.baseapplication.jncax.refresh.iml.ILoadingLayout.State;
		...
		IPullToRefresh<T>
{
	...
	protected void resetHeaderLayout()
	{
		...
		{
			smoothScrollTo(-mHeaderHeight > -300?-mHeaderHeight:-300);
			return;
		}
